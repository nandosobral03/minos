...
const AboutCells = () => {
    ...
    const descriptions = {
        ...
        start: "Start cell, the cell from which the algorithm starts pathfinding, at all points there can be only one start cell",
            ...
            <h1 className={styles.cellTitle}>
                ...
                cellsArray.map((cell, index) => {
                    return (
                        ...
                        <div  className={`${styles.cell} ${cell.class}`}>
                        </div>
